...
slug: bookmarks/configuraciones
---
...
- [Configurar Ubuntu](/docs/ubuntu/configuracion)
...
- [Restaurar touchpad II](/docs/ubuntu/touchpad)
- [Restaurar drivers Nvidia](/docs/ubuntu/nvidia)
...
> Para configurar `oh my zsh` puedes seguir esta [guía](/docs/ubuntu/configuracion#zsh)
...
> Puedes ver como instalar `Git` [aquí](/docs/ubuntu/configuracion#git).
...
- [VSCode Plugins](/docs/herramientas/vscode-plugins)
