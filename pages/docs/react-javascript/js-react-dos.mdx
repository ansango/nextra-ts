...
slug: react-javascript/js-react-dos
---
...
> Puedes ver algunos pequeños tricks con `spread` [aquí](/docs/javascript-array/spread-tricks)
...
> Puedes repasar todos los métodos de array más usados [aquí](/docs/javascript-array/array-methods)
