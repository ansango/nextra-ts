...
summary: Cómo instalar Firefox Developer Edition en Ubuntu sin morir en el intento.
category: ubuntu
tags:
  - ubuntu
  - terminal
...
¿Quieres instalar y utilizar Firefox Developer Edition en tu Ubuntu y no sabes cómo hacerlo? Si tu respuesta es sí, entonces este artículo es para ti. De nada 😃
...
Lo último es ejecutar un comando para crear un acceso directo de Unity. Después de crear este archivo, podremos buscar "Firefox Developer Edition" nuestro Dashboard:
